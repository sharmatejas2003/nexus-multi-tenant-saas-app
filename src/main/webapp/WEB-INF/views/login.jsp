...
<head>
    ...
    <style>
        :root{--accent:#6c63ff;--accent2:#ff6584;--accent3:#43e97b;--bg:#0a0a0f;--bg2:#111118;--border:#2a2a3a;--text:#e8e8f0;--text2:#8888aa;}
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .form-input{width:100%;background:var(--bg2);border:1px solid var(--border);color:var(--text);padding:12px 16px;border-radius:10px;font-size:14px;font-family:'DM Sans',sans-serif;transition:all 0.2s;}
        ...
        .btn-google{width:100%;padding:12px;background:var(--bg2);border:1px solid var(--border);color:var(--text);border-radius:10px;font-size:14px;font-weight:500;font-family:'DM Sans',sans-serif;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:10px;text-decoration:none;transition:all 0.2s;}
...
<div class="auth-box">
    ...
    <c:if test="${param.joined != null}">
        <div class="alert-success">✅ You've joined the workspace! Sign in to continue.</div>
    </c:if>
    <c:if test="${param.deleted != null}">
        <div class="alert-success">✅ Workspace deleted successfully.</div>
    </c:if>
